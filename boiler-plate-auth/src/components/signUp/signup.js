...
class SignUp extends Component {
    ...
    constructor(props) {
        ...
        //     "O-"
        // ]
        this.state = { email: '', password: '', name: '', gender: 1, address: '',  };
    ...
    handleLoginSubmit(evt) {
        ...
        var userObj = { email: email, password: password, name: name, gender: gender, address: address,  cellNumber: cellNumber };
